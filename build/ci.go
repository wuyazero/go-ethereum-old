...
import (
	...
	"github.com/wuyazero/go-ethereum/internal/build"
	"github.com/wuyazero/go-ethereum/params"
	sv "github.com/wuyazero/go-ethereum/swarm/version"
)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/wuyazero/go-ethereum/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/wuyazero/go-ethereum/mobile")
