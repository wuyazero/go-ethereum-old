...
import (
	...
	"github.com/wuyazero/go-ethereum/consensus/misc"
	"github.com/wuyazero/go-ethereum/core/state"
	"github.com/wuyazero/go-ethereum/core/types"
	"github.com/wuyazero/go-ethereum/crypto/sha3"
...
func calcDifficultyByzantium(time uint64, parent *types.Header) *big.Int {
	// https://github.com/wuyazero/EIPs/issues/100.
	// algorithm:
	// diff = (parent_diff +
	...
	// https://github.com/wuyazero/EIPs/pull/669
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/wuyazero/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +
