...
import (
	...
	"github.com/wuyazero/go-ethereum/accounts/abi"
...
func TestNewUnpacker(t *testing.T) {
	...
	testcases := []unpackTest{
		...
		}, { // https://github.com/wuyazero/wiki/wiki/Ethereum-Contract-ABI#examples
...
[
	...
	for _, hexdata := range []string{
		...
		// From https://github.com/wuyazero/wiki/wiki/Ethereum-Contract-ABI
